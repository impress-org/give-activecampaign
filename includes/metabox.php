		...
		'fields'    => array(
			array(
				...
				'options' => array(
					...
					'customized' => esc_html__( 'Customize', 'give-activecampaign' ),
			...
			array(
				...
				'desc'          => esc_html__( 'Would you like the newsletter opt-in checkbox checked by default? This will override the global opt-in default setting.',
					'give-activecampaign' ),
				'options'       => array(
					'on' => esc_html__( 'Checked', 'give-activecampaign' ),
					'off'  => esc_html__( 'Unchecked', 'give-activecampaign' ),
				),
				'default'       => 'off',
				'type'          => 'radio_inline',
			...
			array(
				...
				'desc'          => esc_html__( 'Select the list you wish for all donors to subscribe to by default. This will override the global lists setting.',
					'give-activecampaign' ),
				'type'          => 'chosen',
				'data_type'     => 'multiselect',
				'style'         => 'width: 40%',
			...
			array(
				...
				'desc'          => esc_html__( 'This is the text shown by default next to the ActiveCampaign sign up checkbox. This will override the global label setting.',
					'give-activecampaign' ),
				'type'          => 'text',
				'default'       => esc_html__( 'Subscribe to our newsletter', 'give-activecampaign' ),
				'wrapper_class' => 'give-activecampaign-metabox-field give-hidden',
			),
			array(
