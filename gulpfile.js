...
gulp.task( 'pot', function() {
	return gulp.src( '**/*.php' )
		.pipe( sort() )
		.pipe( wpPot( {
			package: 'Give-ActiveCampaign',
			domain: 'give-activecampaign', //textdomain
			destFile: 'give-activecampaign.pot',
			bugReport: 'https://github.com/impress-org/give-activecampaign/issues/new',
			lastTranslator: '',
...
gulp.task( 'textdomain', function() {
	var options = {
		text_domain: 'give-activecampaign',
		keywords: [
			'__:1,2d',
			'_e:1,2d',
			'_x:1,2c,3d',
